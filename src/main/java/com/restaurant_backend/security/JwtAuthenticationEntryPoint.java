...
import com.restaurant_backend.exception.CustomErrorRecord;
...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        CustomErrorRecord errorRecord =
                new CustomErrorRecord(LocalDateTime.now(), exceptionMsg, request.getRequestURI());
